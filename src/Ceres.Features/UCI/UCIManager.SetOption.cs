  ...
  public partial class UCIManager
  {
    ...
    void ProcessSetOption(string command)
    {
      ...
      switch (name.ToLower())
      {
        ...
        case "cpuctbase":
          SetFloat(value, 0, float.MaxValue, ref (CeresEngine is not null ? ref CeresEngine.ChildSelectParams.CPUCTBase : ref cpuctBase));
          break;
        ...
        case "cpuctbaseatroot":
          SetFloat(value, 0, float.MaxValue, ref (CeresEngine is not null ? ref CeresEngine.ChildSelectParams.CPUCTBaseAtRoot : ref cpuctBaseAtRoot));
          break;
        ...
        case "policytemperature":
          SetFloat(value, 0, float.MaxValue, ref (CeresEngine is not null ? ref CeresEngine.ChildSelectParams.PolicySoftmax : ref policySoftmax));
          break;
